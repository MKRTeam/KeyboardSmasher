...
namespace Gameplay.ExerciseMachine
{
    ...
    public class WordsOnReaction : ExerciseMachine
    {
        ...
        public static void Init() {
            ...
            "Являются довольно любопытными животными." + 
            "Главные чувства - слух и обоняние. Не различают цветов, особенно днем, поэтому могут очень близко подойти к неподвижному человеку со стороны ветра." +
            ...
            "У обоих полов есть перепончатые лапы, которые способны защитить" +
            " в холодное время года. Они имеют ряды маленьких, удлиненных роговых когтей, обеспечивающих эффект снегоступов.",
