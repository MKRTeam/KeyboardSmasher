...
namespace KeyboardSmasher.GUI.Controls
{
    ...
    public partial class InfoControl : UserControl
    {
        ...
        #region константы
        private const string ABOUT_PROGRAMM = @"{\rtf1\ansi Программа \i KeyboardSmasher  \i0 предназначена в качестве тренажера для обучения слепой печати в игровой форме. \line \line" +
                                                @"\b Язык \b0 \line" +
                                                ...
                                                @"\b Уровни \b0 \line" +
                                                @"Имеется система сложности (3 уровня). При увеличении уровня расширяется набор используемых символов. Так на первом уровне используются сиволы «фывапролджэ», на 2-м к набору добавляются буквы «йцукенгшщзхъ», на 3-м добавляются «ячсмитьбю». \line"+
                                                @"}";
        ...
        private const string ABOUT_AUTHORS= @"{\rtf1\ansi Создателем данного приложения является команда студентов. Надеемся, вам понравилось. \line" +
            @"Связаться с нами можно в группе в вк «KeyboardSmasher - официальная страница игры»:" +
            @"\u  https://vk.com/keyboardsmashergame \u0" +
            @"}";
        #endregion
